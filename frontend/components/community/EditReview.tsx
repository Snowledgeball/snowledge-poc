...
export default function EditReview({
    ...
    const votesPercentage = contributorsCount > 0
                ...
                <Card className="p-6 mb-6">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg mb-6 border border-blue-100">
                        <div className="flex items-center mb-2">
                            ...
                            <h3 className="font-medium text-blue-800">Statistiques de vote</h3>
                        </div>
                        <p className="text-sm text-blue-700 mb-2">
                            {votesCount} votes sur {contributorsCount} contributeurs ({votesPercentage}%)
                        </p>
                    ...
                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                        ...
                        <div className="flex flex-col md:flex-row gap-4 mb-6">
                            <button
                                ...
                                className={`flex-1 p-4 rounded-lg border-2 flex items-center justify-center gap-2 transition-colors ${decision === "APPROVED"
                            ...
                            <button
                                ...
                                className={`flex-1 p-4 rounded-lg border-2 flex items-center justify-center gap-2 transition-colors ${decision === "REJECTED"
