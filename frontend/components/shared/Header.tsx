            ...
            <div className="max-w-[95rem] mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden lg:flex items-center space-x-4">
                        <button onClick={() => session?.user ? router.push("/create-community") : setIsSignupModalOpen(true)}
                            ...
                            <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_5706_11168)">
                                    <path d="M1.66675 1.66699L13.7501 4.58366L15.0001 10.8337L10.8334 15.0003L4.58341 13.7503L1.66675 1.66699ZM1.66675 1.66699L7.98841 7.98866M10.0001 15.8337L15.8334 10.0003L18.3334 12.5003L12.5001 18.3337L10.0001 15.8337ZM10.8334 9.16699C10.8334 10.0875 10.0872 10.8337 9.16675 10.8337C8.24627 10.8337 7.50008 10.0875 7.50008 9.16699C7.50008 8.24652 8.24627 7.50033 9.16675 7.50033C10.0872 7.50033 10.8334 8.24652 10.8334 9.16699Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                </g>
                                <defs>
