...
export default function ContributionDetailPage() {
    ...
    return (
        <div className="container mx-auto py-8 px-4">
            ...
            <Card className="p-6">
                <h2 className="text-xl font-semibold mb-4">Feedbacks reçus ({contribution.community_posts_contribution_reviews.length})</h2>

                {contribution.community_posts_contribution_reviews.length === 0 ? (
                    <p className="text-gray-500 italic">Aucun feedback reçu pour le moment</p>
                ) : (
                    <div className="space-y-6">
                        {contribution.community_posts_contribution_reviews.map((review) => (
