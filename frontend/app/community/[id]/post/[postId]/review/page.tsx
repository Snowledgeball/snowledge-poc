                    ...
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="flex items-center space-x-4">
                                ...
                                >
                                    <CheckCircle className={`w-6 h-6 ${reviewStatus === "APPROVED" ? "text-green-500" : "text-gray-400"
                                        }`} />
                                ...
                                >
                                    <XCircle className={`w-6 h-6 ${reviewStatus === "REJECTED" ? "text-red-500" : "text-gray-400"
                                        }`} />
